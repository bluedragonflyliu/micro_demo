...
func (e *User) Call(ctx context.Context, req *api.Request, rsp *api.Response) error {
	...
	if !ok {
		return errors.InternalServerError("com.abc.api.user.user.call", "user client not found")
	}
	...
	if err != nil {
		return errors.InternalServerError("com.abc.api.user.user.call", err.Error())
	}
